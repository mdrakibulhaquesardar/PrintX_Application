        ...
        child: Center(
          child: Column(
            ...
            children: <Widget>[
              ...
              if (selectedFile == null) ...[
                Center(child: Image.network("https://cdni.iconscout.com/illustration/premium/thumb/upload-file-to-cloud-illustration-download-in-svg-png-gif-formats--uploading-storage-data-internet-web-and-mobile-application-pack-business-illustrations-3722766.png", height: 180)),
              ],
              if (selectedFile == null) ...[
                Column(
                  crossAxisAlignment: CrossAxisAlignment.start,
              ...
              // File Upload Widget with Dotted Border
              GestureDetector(
                onTap: () async {
                  // Open File Picker
